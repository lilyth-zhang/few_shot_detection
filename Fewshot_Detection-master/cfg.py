...
__C.sunmi_classes = ["head1", "head2", "head3", "head4"]
...
def __configure_data(dataopt):
    ...
    if dataopt['data'] == 'voc':
        ...
        __C.save_interval = 2
    elif dataopt['data'] == 'sunmi':
        __C.classes = __C.sunmi_classes
...
#     print(buf[start:start+num_w].shape)
