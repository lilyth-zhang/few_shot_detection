...
few_nums = [1, 3, 5, 10, 20]
# few_nums = [20]

DROOT = '/home/zhangli/few_shot_detection/mypj/data_root'
root =  DROOT + '/voclist/'
rootfile =  DROOT + '/sunmi_train.txt'
...
#                          .replace('.jpg', '.txt').replace('.png','.txt')
    labpath = imgpath.replace('jpegimgs', 'labels_1c/{}'.format(cls_name)) \
                         .replace('.jpg', '.txt').replace('.png','.txt')
    print(labpath)
...
#                                  .replace('.jpg', '.txt').replace('.png','.txt')
        labpath = imgpath.strip().replace('jpegimgs', 'labels_1c/{}'.format(set2cls[imgpath.split('/')[7]])) \
                                 .replace('.jpg', '.txt').replace('.png','.txt')
